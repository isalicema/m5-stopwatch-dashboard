...
class FeaturePageTests(unittest.TestCase):
    ...
    def test_feature_footer_tolerates_fingertip_drift_without_stealing_swipes(self):
        ...
        self.assertIn("kAIHotspotActionTouchX = 70", self.interaction)
        self.assertIn("kAIHotspotActionTouchRight = 390", self.interaction)
        self.assertIn("dashboardAIHotspotTouchTarget", self.interaction)
